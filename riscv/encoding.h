...
#define MATCH_XC_XCR2GPR 0x1000002b
#define MASK_XC_XCR2GPR  0xfff8707f
#define MATCH_XC_GPR2XCR 0x1100002b
#define MASK_XC_GPR2XCR  0xfff0787f
#define MATCH_XC_INIT 0x1110082b
#define MASK_XC_INIT  0xffffffff
#define MATCH_XC_PADD 0x600002b
#define MASK_XC_PADD  0x1f08787f
#define MATCH_XC_PSUB 0x600082b
#define MASK_XC_PSUB  0x1f08787f
#define MATCH_XC_PMUL_L 0xe00002b
#define MASK_XC_PMUL_L  0x1f08787f
#define MATCH_XC_PMUL_H 0xe00082b
#define MASK_XC_PMUL_H  0x1f08787f
#define MATCH_XC_PCLMUL_L 0xe08002b
#define MASK_XC_PCLMUL_L  0x1f08787f
#define MATCH_XC_PCLMUL_H 0xe08082b
#define MASK_XC_PCLMUL_H  0x1f08787f
#define MATCH_XC_PSLL 0x1600002b
#define MASK_XC_PSLL  0x1f08787f
#define MATCH_XC_PSRL 0x1600082b
#define MASK_XC_PSRL  0x1f08787f
#define MATCH_XC_PROT 0x1608082b
#define MASK_XC_PROT  0x1f08787f
#define MATCH_XC_PSLL_I 0x1e00002b
#define MASK_XC_PSLL_I  0x1e08787f
#define MATCH_XC_PSRL_I 0x1e00082b
#define MASK_XC_PSRL_I  0x1e08787f
#define MATCH_XC_PROT_I 0x1e08082b
#define MASK_XC_PROT_I  0x1e08787f
#define MATCH_XC_RNGSEED 0x800002b
#define MASK_XC_RNGSEED  0xfff87fff
#define MATCH_XC_RNGSAMP 0x810082b
#define MASK_XC_RNGSAMP  0xfffff87f
#define MATCH_XC_RNGTEST 0x820002b
#define MASK_XC_RNGTEST  0xfffff07f
#define MATCH_XC_CMOV_T 0x1800082b
#define MASK_XC_CMOV_T  0xff08787f
#define MATCH_XC_CMOV_F 0x1800002b
#define MASK_XC_CMOV_F  0xff08787f
#define MATCH_XC_SHA3_XY 0xc00002b
#define MASK_XC_SHA3_XY  0x3e00707f
#define MATCH_XC_SHA3_X1 0x1400002b
#define MASK_XC_SHA3_X1  0x3e00707f
#define MATCH_XC_SHA3_X2 0x2400002b
#define MASK_XC_SHA3_X2  0x3e00707f
#define MATCH_XC_SHA3_X4 0x1c00002b
#define MASK_XC_SHA3_X4  0x3e00707f
#define MATCH_XC_SHA3_YX 0x3400002b
#define MASK_XC_SHA3_YX  0x3e00707f
#define MATCH_XC_LDR_BU 0x200002b
#define MASK_XC_LDR_BU  0x3e00787f
#define MATCH_XC_LDR_HU 0x1200002b
#define MASK_XC_LDR_HU  0x3e00787f
#define MATCH_XC_LDR_W 0x2200002b
#define MASK_XC_LDR_W  0xfe00787f
#define MATCH_XC_STR_B 0x200082b
#define MASK_XC_STR_B  0x3e00787f
#define MATCH_XC_STR_H 0x1200082b
#define MASK_XC_STR_H  0x3e00787f
#define MATCH_XC_STR_W 0x2200082b
#define MASK_XC_STR_W  0xfe00787f
#define MATCH_XC_AESSUB_ENC 0x400002b
#define MASK_XC_AESSUB_ENC  0xff08787f
#define MATCH_XC_AESSUB_ENCROT 0x400082b
#define MASK_XC_AESSUB_ENCROT  0xff08787f
#define MATCH_XC_AESSUB_DEC 0x408002b
#define MASK_XC_AESSUB_DEC  0xff08787f
#define MATCH_XC_AESSUB_DECROT 0x408082b
#define MASK_XC_AESSUB_DECROT  0xff08787f
#define MATCH_XC_AESMIX_ENC 0x500002b
#define MASK_XC_AESMIX_ENC  0xff08787f
#define MATCH_XC_AESMIX_DEC 0x508002b
#define MASK_XC_AESMIX_DEC  0xff08787f
#define MATCH_XC_SCATTER_B 0xa00082b
#define MASK_XC_SCATTER_B  0xff00787f
#define MATCH_XC_GATHER_B 0xa00002b
#define MASK_XC_GATHER_B  0xff00787f
#define MATCH_XC_SCATTER_H 0xb00082b
#define MASK_XC_SCATTER_H  0xff00787f
#define MATCH_XC_GATHER_H 0xb00002b
...
#define MATCH_XC_IPBIT 0x10202b
#define MASK_XC_IPBIT  0x7f8787f
#define MATCH_XC_PBIT 0x10282b
#define MASK_XC_PBIT  0x7f8787f
#define MATCH_XC_PBYTE 0x30202b
#define MASK_XC_PBYTE  0xf8787f
#define MATCH_XC_INS 0x30282b
#define MASK_XC_INS  0x38787f
#define MATCH_XC_BMV 0x38202b
#define MASK_XC_BMV  0x38787f
...
DECLARE_INSN(xc_init, MATCH_XC_INIT, MASK_XC_INIT)
...
DECLARE_INSN(xc_ipbit, MATCH_XC_IPBIT, MASK_XC_IPBIT)
DECLARE_INSN(xc_pbit, MATCH_XC_PBIT, MASK_XC_PBIT)
DECLARE_INSN(xc_pbyte, MATCH_XC_PBYTE, MASK_XC_PBYTE)
DECLARE_INSN(xc_ins, MATCH_XC_INS, MASK_XC_INS)
DECLARE_INSN(xc_bmv, MATCH_XC_BMV, MASK_XC_BMV)
